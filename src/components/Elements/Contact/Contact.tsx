    ...
    <div className="bg-slate-100">
      <Container>
        <div className="mx-auto flex flex-col items-center justify-center  ">
          <p className="mt-4 text-sm font-bold tracking-wider uppercase text-cyan-700">Contact</p>
          ...
          {state.succeeded ? (
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-2xl">
              ...
              <button
                aria-label="Submit"
                role="button"
                className="mt-2 flex w-full cursor-pointer justify-center rounded-md bg-cyan-700 py-2  text-white transition-colors duration-150 hover:bg-cyan-800"
                type="submit"
